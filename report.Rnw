...
makeFootnote("Proportion of scheduling rounds computing processes.", color = "black")
@
...
<<SchedRoundParThreshold,echo = FALSE,fig = TRUE>>=
library('ggplot2')
library('gridExtra')
library('plyr')
library('data.table')
...
plot(g)
makeFootnote("Speedup obtained in relation with the amount of processes computed by scheduling round.", color = "black")
@
