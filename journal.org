...
* September
** 1 [%]
   - [ ] comments about how to regenerate data in report.
   - [ ] add units/labels to plots. Add conclusions to plot
   - [ ] Re-run busy-waiters. Re-check speedup of scheduling rounds.
