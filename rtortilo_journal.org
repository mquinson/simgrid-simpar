...
** 7 [33%]
     ...
     - [ ] (In Progress) Do some benchmarks with that.
     - [ ] Check cache misses of previous/optimized version with perf.
     - [X] Write section in report, plot a graph


  LEARN HOW TO SCHEDULE A SIMULATION FOR A NIGHT, A WEEKEND
   - [ ] make tests with 500000, 1000000 nodes (schedule for a night, weekend).
   - [ ] maybe try with 75000, 50000 nodes as well.
