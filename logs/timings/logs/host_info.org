#+TITLE: Chord experiment on parapluie-38.rennes.grid5000.fr
#+DATE: Wed Sep 24 10:42:46 CEST 2014
#+AUTHOR: root
 
* People logged when experiment started:
root     pts/0        2014-09-24 09:44 (frennes.rennes.grid5000.fr)
* Hostname
...
Active(file):     214444 kB
Inactive(file):   883176 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
SHELL=/bin/bash
TERM=xterm
SSH_CLIENT=172.16.111.106 58935 22
SSH_TTY=/dev/pts/0
LC_ALL=en_US.UTF-8
USER=root
...
LANGUAGE=en_US:en
LOGNAME=root
SSH_CONNECTION=172.16.111.106 58935 172.16.99.38 22
_=/usr/bin/printenv
* Tools
