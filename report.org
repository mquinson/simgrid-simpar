...
g1<-ggplot(df, aes(x=nodes,y=value, group=threads, colour=threads)) + geom_line() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.title.x = element_blank(), legend.position="none", axis.title.y=element_text("Speedup")) + ggtitle("Constant Mode")
...
g2<-ggplot(df2, aes(x=nodes,y=value, group=threads, colour=threads)) + geom_line() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_blank(), axis.title.x = element_text("Nodes"), axis.title.y = element_text( "Speedup")) + ggtitle("Precise Mode") + scale_fill_discrete(name="threads")
...
g1<-ggplot(df, aes(x=nodes,y=value, group=threads, colour=threads))  + geom_line() +
    ...
    scale_y_continuous(breaks=c(1.0,1.5,2.0,2.5,3.0,4.0)) + ylab("Speedup Constant mode")
...
g2<-ggplot(df2, aes(x=nodes,y=value, group=threads, colour=threads)) + geom_line() +
    ...
    axis.title.x = element_text("Nodes"), legend.position="bottom") + 
    scale_x_continuous(breaks=c(1000,5000,10000,25000,50000,75000,100000)) +
