#+TITLE: Chord experiment on parapluie-22.rennes.grid5000.fr
#+DATE: Wed Oct  8 10:04:50 CEST 2014
#+AUTHOR: root
 
* People logged when experiment started:
root     pts/0        2014-10-08 09:28 (frennes.rennes.grid5000.fr)
* Hostname
parapluie-22.rennes.grid5000.fr
* System information
Linux parapluie-22.rennes.grid5000.fr 3.2.0-4-amd64 #1 SMP Debian 3.2.54-2 x86_64 GNU/Linux
* CPU info
processor	: 0
...
Active(file):     202136 kB
Inactive(file):   897584 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
SHELL=/bin/bash
TERM=xterm
SSH_CLIENT=172.16.111.106 56458 22
SSH_TTY=/dev/pts/0
LC_ALL=en_US.UTF-8
USER=root
...
LANGUAGE=en_US:en
LOGNAME=root
SSH_CONNECTION=172.16.111.106 56458 172.16.99.22 22
_=/usr/bin/printenv
* Tools
