...
** 7 [%]
  ...
  - [ ] Start benchmark of last version with all optimizations enabled
    (core binding, adaptive, real threshold)
  - [ ] Check two tables and add values of 1m,2m when ready.
  - sr-par-threshold: used density function, not dots.
  - sr-times and sr-par-threshold with .png's
  - captions are not showing, why?
