...
DIR = "../timings/logs"    # The dir where to gather the logs
MODES = ['precise']    # The modes to analyse
OUTPUT_FILE = "./total_times_orig.csv"  # Put proper name here

SIZES = ['10000','50000','100000','300000', '1000000'] #,'500000','1000000']
