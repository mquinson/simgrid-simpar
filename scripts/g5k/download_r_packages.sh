...
wget http://cran.r-project.org/src/contrib/Archive/reshape2/reshape2_1.0.tar.gz
...
wget http://cran.r-project.org/src/contrib/Archive/data.table/data.table_1.8.10.tar.gz
wget http://cran.r-project.org/src/contrib/Archive/gridExtra/gridExtra_0.9.tar.gz
