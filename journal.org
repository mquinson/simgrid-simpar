...
** 4 [%]
   ...
   - [ ] Add scripts into file.
   - [ ] add units/labels to plots. Add conclusions to plots. Recheck plots, redo the sr-times, sr-par-thresh, and sr-distribution (new one). Redo busy-waiters.

   - [ ] run for once and all speedups with 1000000 and 2000000 nodes.
