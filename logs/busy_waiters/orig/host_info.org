* Host
Linux parapluie-2.rennes.grid5000.fr 3.2.0-4-amd64 #1 SMP Debian 3.2.54-2 x86_64 GNU/Linux
* CPU info
processor	: 0
...
Active(file):     485536 kB
Inactive(file):  1442104 kB
Unevictable:           0 kB
Mlocked:               0 kB
...
SHELL=/bin/bash
TERM=xterm
SSH_CLIENT=172.16.111.106 48459 22
SSH_TTY=/dev/pts/0
LC_ALL=en_US.UTF-8
USER=root
...
LANGUAGE=en_US:en
LOGNAME=root
SSH_CONNECTION=172.16.111.106 48459 172.16.99.2 22
_=/usr/bin/printenv
* Tools
** Compiler
