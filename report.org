...
A naive implementation of this algorithm, showed a small relative
...
250 processes, which was estimated as an optimal starting threshold for
this algorithm in previous section.
...
The changes proposed are very independent between each other, a fact
...
In top of the Figure XX(TODO: CREATE FIGURE), we can see the speedups
