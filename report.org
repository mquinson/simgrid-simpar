...
takes around 30 MB (independent of the amount of threads launched),
while when simulating 3000000 nodes, the maximum memory used is
between 7.38 and 7.60 GB.
