...
This can be run from here or just by putting testall_sr.sh and
get_sr_counts.py in the examples/msg/chord folder of your SimGrid, and
running ./testall_sr.sh
