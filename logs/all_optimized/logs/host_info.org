#+TITLE: Chord experiment on parapluie-31.rennes.grid5000.fr
#+DATE: Tue Oct 21 10:02:34 CEST 2014
#+AUTHOR: root
 
* People logged when experiment started:
root     pts/0        2014-10-21 09:32 (frennes.rennes.grid5000.fr)
* Hostname
parapluie-31.rennes.grid5000.fr
* System information
...
SHELL=/bin/bash
TERM=xterm
SSH_CLIENT=172.16.111.106 40870 22
SSH_TTY=/dev/pts/0
LC_ALL=en_US.UTF-8
USER=root
...
LANGUAGE=en_US:en
LOGNAME=root
SSH_CONNECTION=172.16.111.106 40870 172.16.99.31 22
_=/usr/bin/printenv
* Tools
