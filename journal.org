...
** 2 [%]
1000 nodes, precise model, 16 threads failed (SR exp.)
   - [ ] add units/labels to plots. Add conclusions to plots. Recheck plots, redo the sr-times, sr-speedup, and sr-distribution. Redo busy-waiters.
