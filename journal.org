...
** 24 [20%]
  ...
  - [ ] Learn how to launch an experiment for a weekend (if thats
    possible)
  - [ ] Absolute numbers in section 5.2 (Adaptive algorithm). Write
    something + maybe a table with absolute times. (Add millions when ready)
  - [ ] Figure 1:
  ...
  - [ ] Make new plot of SR w/new idea.
  - [ ] Plot proportions of SR as stacked chart.
  - [ ] Push adaptive algorithm code to repository.
